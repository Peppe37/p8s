...
class RequestFactory:
    ...
    def get(self, path: str, **kwargs: Any) -> dict:
        ...
        return {
            ...
            "headers": {**self.defaults.get("headers", {}), **kwargs.get("headers", {})},
        }
...
def assert_json_contains(response: Any, key: str, value: Any = None, msg: str = "") -> None:
...
def assert_redirect(response: Any, expected_url: str | None = None, msg: str = "") -> None:
